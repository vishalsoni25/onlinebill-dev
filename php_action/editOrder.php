	...
	if($readyToUpdateOrderItem) {
		...
		for($x = 0; $x < count($_POST['productName']); $x++) {			
			...
			while ($updateProductQuantityResult = $updateProductQuantityData->fetch_row()) {
				...
				VALUES ({$orderId}, '".$_POST['productName'][$x]."', '".$_POST['quantity'][$x]."', '".$_POST['rateValue'][$x]."', '".$_POST['totalValue'][$x]."','".$_POST['hsncode'][$x]."','".$_POST['g_weight'][$x]."','".$_POST['huid'][$x]."','".$_POST['purity'][$x]."','".$_POST['n_weight'][$x]."','".$_POST['grate'][$x]."','".$_POST['hallmark'][$x]."','".$_POST['l_p_g'][$x]."','".$_POST['gst'][$x]."', 1)";
