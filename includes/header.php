...
<head>
	...
	<title>Shakuntalam Jewellers</title>
...
<li id="navCustomer"><a href="addcustomer.php"> <i class="glyphicon glyphicon-user"></i> Customer</a></li> 		

        <li id="navProduct"><a href="product.php"> <i class="glyphicon glyphicon-ruble"></i> Product </a></li> 
		<li id="navAddOrder"><a href="orders.php?o=add"> <i class="glyphicon glyphicon-plus"></i> Add Rough Orders</a></li> 
		<li id="topNavManageOrder"><a href="orders.php?o=manord"> <i class="glyphicon glyphicon-edit"></i> Manage Rough Orders</a></li> 
<li id="navCal"><a href="calculator.php"> <i class="glyphicon glyphicon-modal-window"></i> Calculator </a></li>		
<!--
